...
![An example context](https://olshansky.b-cdn.net/assets/images/Context.jpg "An example context")
...
![Level encoding](https://olshansky.b-cdn.net/assets/images/LevelEncoding.jpg "Level encoding")
